...
{
	public partial class EnemyD1CorpDoneBSpineAnimationController : EnemySpineAnimationController
	{
		...
		private EnemyD1CorpDoneBAttackController? _attackController;
		...
		private EnemyD1CorpDoneBAttackController? ResolveAttackController()
		{
			...
			_attackController = GetNodeOrNull<EnemyD1CorpDoneBAttackController>(AttackControllerPath);
			if (_attackController == null)
				_attackController = Enemy.GetNodeOrNull<EnemyD1CorpDoneBAttackController>(AttackControllerPath);
		...
		private bool IsExpectedHitAnimation(EnemyD1CorpDoneBAttackController controller, string animationName)
		{
