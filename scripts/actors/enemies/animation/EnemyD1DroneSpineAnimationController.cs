...
{
	public partial class EnemyD1DroneSpineAnimationController : EnemySpineAnimationController
	{
		...
		private EnemyD1DroneAttackController? _attackController;
		...
		private EnemyD1DroneAttackController? ResolveAttackController()
		{
			...
			_attackController = GetNodeOrNull<EnemyD1DroneAttackController>(AttackControllerPath);
			if (_attackController == null)
				_attackController = Enemy.GetNodeOrNull<EnemyD1DroneAttackController>(AttackControllerPath);
		...
		private bool IsExpectedHitAnimation(EnemyD1DroneAttackController controller, string animationName)
		{
